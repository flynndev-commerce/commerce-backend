...
async def create_test_order(
    ...
    test_customer_account: dict[str, object] | None = None,
    test_seller_account: dict[str, object] | None = None,
) -> OrderRead:
    """
    통합 테스트용 주문을 생성하고 OrderRead 모델을 반환하는 헬퍼 함수
    공통 고객/판매자 fixture를 활용합니다.
    """
