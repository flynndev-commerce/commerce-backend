...
class TestProductPermission:
    def test_create_product_forbidden_for_buyer(self, test_app: FastAPI, client: TestClient) -> None:
    ...
    def test_create_product_success_for_seller(self, test_app: FastAPI, client: TestClient) -> None:
